...
/// Локальная текстовая модерация на устройстве.
/// Сейчас это лёгкий rule-based слой, но вся архитектура вызовов уже построена так,
/// чтобы title и description всегда проходили именно через device-side проверку.
