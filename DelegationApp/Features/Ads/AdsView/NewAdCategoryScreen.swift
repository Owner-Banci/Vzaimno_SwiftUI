...
struct StructuredCreateAdScreen: View {
    ...
    var body: some View {
        ...
        .onAppear {
            draft.syncAutoGeneratedDescriptionIfNeeded()
        }
        .onChange(of: draft.assembledDescription) { _, _ in
            draft.syncAutoGeneratedDescriptionIfNeeded()
        }
    }
        ...
        CreateAdSectionCard(
            ...
            VStack(alignment: .leading, spacing: 8) {
                HStack(spacing: 6) {
                    ...
                    if let mark = draft.moderationMarks["title"] {
            ...
            CreateAdTextArea(
                label: "Описание",
                placeholder: draft.assembledDescription.isEmpty ? notesPlaceholder : draft.assembledDescription,
                text: $draft.notes,
